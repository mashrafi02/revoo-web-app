        ...
        
        {
            user === null ? (
                <div className="flex space-x-2 md:space-x-4">
                    <Link
                        to="/login"
                        className="px-2 text-sm md:text-base md:px-4 py-2 border font-semibold border-white text-white rounded-lg hover:bg-red-400 hover:text-white duration-300"
                    >
                        Log In
                    </Link>
                    <Link
                        to="/signup"
                        className="px-2 text-sm md:text-base md:px-4 py-2 bg-red-400 font-semibold text-white rounded-lg hover:bg-gray-700 duration-300"
                    >
                        Sign Up
                    </Link>
                </div>
