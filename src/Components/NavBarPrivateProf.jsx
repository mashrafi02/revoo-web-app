...

        {
            user === null ? (
                <div className="flex space-x-4">
                    <Link
                        to="/login"
                        className="px-2 md:px-4 py-2 text-sm md:text-base border font-semibold border-white text-white rounded-lg hover:bg-red-400 hover:text-white duration-300"
                    >
                        Log In
                    </Link>
                    <Link
                        to="/signup"
                        className="px-2 md:px-4 py-2 text-sm md:text-base bg-red-400 font-semibold text-white rounded-lg hover:bg-gray-700 duration-300"
                    >
                        Sign Up
                    </Link>
                </div>
            ...
            (
              <div ref={dropdownRef} className="relative">
                  ...
                  {/* Dropdown Menu */}
                  {open && (
                    <div className="absolute right-0 mt-2 w-48 bg-gray-800 rounded-lg shadow-lg overflow-hidden animate-fadeIn">
                        <Link
                          to={`/${user.username}`}
